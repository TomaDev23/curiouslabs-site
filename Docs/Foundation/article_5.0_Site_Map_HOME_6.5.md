# CuriousLabs HOME Page Animation Map (v6.5)
...
## [SERV-04] ServicesOrbital Component
...
│   duration: 0.5 + (i * 0.1),         │  │                                        │
│   ease: [0.33, 1, 0.68, 1],          │  │ Card hover: whileHover: { y: -10 }     │
│   repeat: Infinity,                  │  │                                        │
│   repeatDelay: 0.1 * i,              │  │                                        │
│   delay: 0.05 * i                    │  │                                        │
│ }                                    │  │                                        │
...
## [PROJ-06] ProjectsLogbook Component
...
## [COMM-07] CommunityHub Component
...
## [CONT-08] ContactTerminal Component
...
│         : "hidden"                 │  │                                          │
│ viewport: {                        │  │ Blinking cursor:                         │
│   once: true,                      │  │ animate: { opacity: [1, 0, 1] }          │
│   margin: '0px 0px -10% 0px'       │  │ transition: { duration: 0.8, repeat }    │
│ }                                  │  │                                          │
└───────────────────────────────────────  └──────────────────────────────────────────
┌─Form Element Animations─────────────┐  ┌─Submit Button Animation────────────────┐
│ Input field focus:                  │  │ whileHover: { scale: 1.05 }             │
│ - Border transitions to purple      │  │ whileTap: { scale: 0.95 }               │
│ - Shadow glow appears               │  │                                          │
│ - transition-all duration-300       │  │ Submit loading state:                    │
│                                     │  │ - Spinner rotation: rotate 360deg        │
│ Error shake animation:              │  │ - Duration: 1s, infinite                 │
│ keyframes x: [0, -10, 10, -10, 0]   │  │                                          │
│ duration: 0.5s                      │  │ Success animation:                       │
...
## [BOT-09] CuriousBotEnhanced Component
...
## [FOOT-10] FooterExperience Component
