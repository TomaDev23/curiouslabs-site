...
export default function Home() {
  ...
  const logoStripOpacity = Math.max(0, 1 - ((scrollY - viewportHeight * 0.3) / (viewportHeight * 0.2)));
    ...
    <main className="min-h-screen bg-deep-black text-white antialiased relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-screen relative">
          ...
          {/* Logo Strip with sticky behavior */}
          <div 
            className="sticky bottom-0 w-full transition-all duration-700 z-20"
            style={{ 
